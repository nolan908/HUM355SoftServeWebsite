document.addEventListener('DOMContentLoaded', () => {
    ...
    function initMap() {
        ...
        const mapNodes = [
            ...
            { id: "Customer", x: 1010, y: 250, l: "Customer", t: essayParagraphs.Customer },
        ...
        const mapLinks = [
            ...
            { source: "Taylor", target: "Worker" }, { source: "Worker", target: "Customer" }, { source: "Taylor", target: "Lockout" }, { source: "Policy", target: "Taylor" }
        ];
